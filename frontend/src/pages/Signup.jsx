  ...
  return (
    <div className="min-h-screen bg-background dark:bg-darkBackground flex pt-20">
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-serif font-bold text-textPrimary dark:text-white mb-2">Create Account</h2>
            <p className="text-textSecondary dark:text-gray-400 text-sm">Join Starline Travel for exclusive benefits.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-[10px] font-bold text-textSecondary dark:text-gray-400 tracking-wider uppercase mb-1.5">Full Name</label>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img 
          src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&q=80&w=1000" 
          alt="Travel" 
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-l from-transparent to-background dark:to-darkBackground"></div>
      </div>
    </div>
  );
};
